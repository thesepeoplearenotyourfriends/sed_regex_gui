...
window.__test = { DIALECTS, switchDialect, update, expressionInput, victimText, outputText, trainerTitle, patternsToggle, inputPaneTitle, outputPaneTitle, trainerResults, getTrainerEntries, messages, trainerSupportFilter };
}());`);
